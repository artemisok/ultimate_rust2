...
pub enum DolphinError {
    #[error("This Doplphin is way too hungry to be cheerful")]
    Hungry,
    #[error("This Doplphin is way too young, what an age")]
    TooYoung,
    #[error("Were not there any more letters to put as name for ya")]
    LongName
}
