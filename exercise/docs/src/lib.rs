...
//!  and is most often deep yellow to orange in coloration.[1] The thick shell contains the seeds and pulp.
//! The name is most commonly used for cultivars of Cucurbita pepo, but some cultivars of Cucurbita maxima, C. argyrosperma, and C. moschata
//! with similar appearance are also sometimes called "pumpkins".
//!
//! ![Pumpkinella](https://upload.wikimedia.org/wikipedia/commons/thumb/5/5c/FrenchMarketPumpkinsB.jpg/700px-FrenchMarketPumpkinsB.jpg)
///
///
...
pub struct Pumpkin {
    /// Roundness is the percentage
    pub roundness: f32,
    /// Orangeness is a number representing the color pattern between 8 to 27
    pub orangeness: i32,
}
...
impl Pumpkin {
    /// If you smash a pumpkin, it will be maybe fun for short term but then you would not be able to make a pie in long term.😭
    pub fn smash(self) {}
}
...
/// Burnt Orange is the color demonstrated with number 13, Please see: [`Pumpkin`]
